...
```
Phase 1 — Foundation                    Phase 2 — Skill Building
Feb 17 ████████████████ Apr 15          Apr 16 ██████████████████████ Jun 30
 8 wks · vocab + habits · target 80-85  11 wks · strategies + Listening push · target 88-93

Phase 3 — Test Prep                     Phase 4 — Final Week & Exam
Jul 1 ██████████████████████ Sep 15     Sep 15 ████ Sep 21
 11 wks · weekly mocks · target 100+     1 wk · review only · ★ EXAM ★
```
...
## Map of Content — Skills & Knowledge Trace

> [!tip] Two checkbox systems
> **MOC checkboxes** = skill/sub-skill mastery ("I can do this reliably"). **Phase Detail checkboxes** below = study tasks ("I completed this activity"). Track both independently.
...
- [ ] [[Academic_Word_List_AWL]] — 570 word families, TOEFL vocabulary, spaced repetition
  - [ ] Core AWL mastery (15-20 words/day via Anki)
  - [ ] Mistake words list (from practice encounters)
  - [ ] Context-based vocabulary from academic reading
  - [ ] Target gaps: ubiquitous, exacerbate, substantiate, proliferate, mitigate, juxtapose, corroborate, pragmatic, ambivalent, unprecedented
- [ ] [[TOEFL_Grammar_Review]] — conditionals, subject-verb agreement, parallel structure
  - [ ] Third conditional (If + past perfect, would have + past participle)
  - [ ] Subject-verb agreement with collective nouns
  - [ ] Parallel structure in writing
  - [ ] Preposition collocations (attributed to, result in, lead to, contribute to)
...
> [!note] With MEXT dropped due to extremely fierce competition, the pathway is **self-funded Kenkyusei only**. This removes the mid-2026 urgency but makes savings verification ([[UTokyo_RIKEN#Financials]]) more critical.

---

## Phase Details

### Phase 1: Foundation (Feb 17 – Apr 15, 2026) — 8 weeks

**Goal:** Build core skills, close vocabulary gaps, establish daily habits.

#### Daily Routine (1-1.5 hours)

| Day | Focus | Time |
|---|---|---|
| Mon | Vocabulary + Reading | 60-90 min |
| Tue | Listening (intensive) | 60-90 min |
| Wed | Vocabulary + Writing | 60-90 min |
| Thu | Listening (extensive) | 60-90 min |
| Fri | Speaking practice | 60-90 min |
| Sat | Full section practice test (rotate weekly) | 60-90 min |
| Sun | Review mistakes + vocabulary review | 60-90 min |
...
**Goal:** Develop test-specific strategies, intensive Listening improvement, first mock test under real conditions.
...
**Goal:** Peak performance. Full test simulations, targeted weakness elimination, test-day readiness.

#### Weekly Schedule

| Week Activity | Mon | Tue | Wed | Thu | Fri | Sat | Sun |
|---|---|---|---|---|---|---|---|
| Focus | Listening | Reading | Speaking | Writing | Listening | **Full Mock** | Review |
...
- [ ] Stop learning new material — focus on review only
- [ ] Do 1 light practice session per day (30 min max)
- [ ] Review vocabulary flashcards
- [ ] Review your "mistake journal" — focus on patterns, not individual questions
- [ ] Get sleep schedule aligned (test is usually morning)
...
| Week | Dates | Focus | Vocab Learned | Practice Tests | Notes |
|---|---|---|---|---|---|
| 1 | Feb 17-23 | Foundation start | | | |
| 2 | Feb 24-Mar 2 | | | | |
| 3 | Mar 3-9 | | | | |
| 4 | Mar 10-16 | | | | |
| 5 | Mar 17-23 | | | | |
| 6 | Mar 24-30 | | | | |
| 7 | Mar 31-Apr 6 | | | | |
| 8 | Apr 7-13 | Phase 1 Checkpoint | | Mock #1 | |
| 9 | Apr 14-20 | Phase 2 start | | | |
| 10 | Apr 21-27 | | | | |
| 11 | Apr 28-May 4 | | | | |
| 12 | May 5-11 | | | | |
| 13 | May 12-18 | | | | |
...
| 17 | Jun 9-15 | | | | |
| 18 | Jun 16-22 | | | | |
| 19 | Jun 23-29 | Phase 2 Checkpoint | | Mock #2 | |
| 20 | Jun 30-Jul 6 | Phase 3 start | | | |
| 21 | Jul 7-13 | | | Mock #3 | |
| 22 | Jul 14-20 | | | | |
| 23 | Jul 21-27 | | | Mock #4 | |
| 24 | Jul 28-Aug 3 | | | | |
...
| 28 | Aug 25-31 | | | | |
| 29 | Sep 1-7 | | | Mock #7 | |
| 30 | Sep 8-14 | Final review | | | |
| 31 | Sep 15-21 | **EXAM WEEK** | | ★ TOEFL ★ | |

---

## Integration with UTokyo Timeline
...
Apr 2026          Phase 2 begins — skill building
    ↓
Jun 2026          Naidaku deadline approaching — need strong English for communication
    ↓
...
> [!tip] Your TOEFL prep has a **secondary benefit**: every hour improving English also improves the quality of your supervisor outreach emails, research statement, and future academic communication. This is not "wasted time" — it directly supports your UTokyo application.

...
source_url: https://github.com/EvoScientist/EvoSkills/blob/main/skills/paper-writing/references/method-templates.md
...
> Faithful copy of `references/method-templates.md` from the [EvoScientist/EvoSkills](https://github.com/EvoScientist/EvoSkills/blob/main/skills/paper-writing/references/method-templates.md) `paper-writing` skill, retrieved 2026-06-26.

...
source_url: https://github.com/EvoScientist/EvoSkills/blob/main/skills/paper-writing/references/introduction-templates.md
...
> Faithful copy of `references/introduction-templates.md` from the [EvoScientist/EvoSkills](https://github.com/EvoScientist/EvoSkills/blob/main/skills/paper-writing/references/introduction-templates.md) `paper-writing` skill, retrieved 2026-06-26.

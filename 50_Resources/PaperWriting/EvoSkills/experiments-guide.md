...
source_url: https://github.com/EvoScientist/EvoSkills/blob/main/skills/paper-writing/references/experiments-guide.md
...
> Faithful copy of `references/experiments-guide.md` from the [EvoScientist/EvoSkills](https://github.com/EvoScientist/EvoSkills/blob/main/skills/paper-writing/references/experiments-guide.md) `paper-writing` skill, retrieved 2026-06-26.

...
author: EvoScientist
title: "Paper Writing"
source_url: https://github.com/EvoScientist/EvoSkills/blob/main/skills/paper-writing/SKILL.md
...
> Faithful copy of `SKILL.md` from the [EvoScientist/EvoSkills](https://github.com/EvoScientist/EvoSkills/blob/main/skills/paper-writing/SKILL.md) `paper-writing` skill, retrieved 2026-06-26.
...
> The skill's own YAML frontmatter is shown in a fenced `yaml` block below (formatting only); the bytes are unchanged.

...
skill_scripts = Path(
    r"D:\Something\research\MATE-Automation-V4\.claude\skills\academic-draw\scripts"
).resolve()
...
def create_morigin_figure():
    ...
    # Rev04 fix H6: move annotation + arrow lower to avoid crowding legend
    ax_mom.annotate(
        "", xy=(2.0, 0.15), xytext=(4.0, 0.15),
    ...
    ax_mom.legend(
        ...
        labelspacing=0.4, handlelength=2.0, borderaxespad=0.5,
    )
    ...
    # Rev04 fix H3: move source from dead-amplitude tail (7.5 fm) to wavefunction peak (~3.5 fm)
    mf_src_x = 3.5
    ...
    arrow_mf = ConnectionPatch(
        ...
        arrowstyle="->", color=C_ORANGE, linewidth=1.5,
    ...
    # Rev04 fix H3: move source from dead-amplitude edge (4.5 fm) to visible oscillation (~2.5 fm)
    src_teal_src_x = 2.5
    ...
    arrow_src_teal = ConnectionPatch(
        ...
        arrowstyle="->", color=C_TEAL, linewidth=1.5,
        connectionstyle="arc3,rad=-0.15",
        mutation_scale=15, zorder=6,
    )
    ...
    arrow_src_blue = ConnectionPatch(
        ...
        arrowstyle="->", color=C_BLUE, linewidth=1.5,
        connectionstyle="arc3,rad=-0.2",
        mutation_scale=15, zorder=6,
    )
    fig.add_artist(arrow_src_blue)

    # --- 8.2 Large conceptual emphasis arrows ---
    ...
    arrow_pair_1 = FancyArrowPatch(
        ...
        color=C_TEAL, linewidth=4, alpha=0.7, zorder=10,
    )
    ...
    arrow_pair_2 = FancyArrowPatch(
        ...
        arrowstyle="->,head_length=12,head_width=8",
        color=C_BLUE, linewidth=4, alpha=0.7, zorder=10,
    )
    ax_nn.add_patch(arrow_pair_2)

    # Large arrow in ax_mom: emphasizes SRC high-momentum tail

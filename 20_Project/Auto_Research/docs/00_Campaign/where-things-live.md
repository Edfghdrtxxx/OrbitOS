...
|---|---|---|
| IMP (group-owned) | First-priority home for durable data; CPU-only jobs run here, no fee. Jump host down since between 2026-09-21 and 2026-09-25; best route is direct from the institute network — see `20_Project/Auto_Research/docs/00_Campaign/fm-ar-jump-net.md` (host-down diagnosis) and `20_Project/Auto_Research/docs/00_Campaign/fm-ar-jump-route.md` (route history and campus procedure). Connection details: MATE-Automation `20_doc/servers/IMP_server_context.md` (path only; no credentials in docs). | `20_Project/Auto_Research/docs/00_Campaign/fm-ar-imp-resume.md` |

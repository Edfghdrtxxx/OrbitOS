...
export const ZTYPES: Record<ZombieTypeId, ZombieArchetype> = {
  ...
  boss:     { hp: 22000, speed: 108, damage: 32, radius: 174, color:'#3D5B2A', eye:'#ffbd2e', score: 6400, xp: 2800, touchCd: 600, minFloor: 1,
              collisionDmg: 40, meleePower: 42, meleeCd: 3000, meleeRange: 280 },

...
export const ZTYPES: Record<ZombieTypeId, ZombieArchetype> = {
  ...
  boss:     { hp: 22000, speed: 180, damage: 32, radius: 174, color:'#3D5B2A', eye:'#ffbd2e', score: 6400, xp: 2800, touchCd: 600, minFloor: 1 },
  ...
  boss_necro:    { hp: 13000, speed: 165, damage: 28, radius: 150, color:'#4a2d6b', eye:'#a8e34b', score: 6400, xp: 2800, touchCd: 600, minFloor: 2,
  ...
  boss_berserker:{ hp: 26000, speed: 210, damage: 36, radius: 168, color:'#a13a2a', eye:'#ffe066', score: 7200, xp: 3200, touchCd: 500, minFloor: 3,
  ...
  boss_queen:    { hp: 19000, speed: 150, damage: 24, radius: 156, color:'#7bb540', eye:'#ffbd2e', score: 6800, xp: 3000, touchCd: 600, minFloor: 2,

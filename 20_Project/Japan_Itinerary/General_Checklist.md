...
- [ ] CV / academic resume
- [ ] Language proficiency certificates as requested: TOEFL iBT (target 100+) -> [[English_Learning]], JLPT -> [[Japanese_Language]]
- [ ] Publications list (if any)
- [ ] Letter of Acceptance (Naidaku) from target supervisor (critical for Kenkyusei route)
...
- [ ] Certificate of Eligibility (COE) - university applies on your behalf -> [[Certificate_of_Eligibility_COE]]
- [ ] Student visa requirements verified -> [[Student_Visa_Japan]]
- [ ] Proof of financial support
- [ ] Acceptance letter from university
- [ ] Valid passport
- [ ] Mission-specific supporting documents required by the embassy/consulate -> [[Mission-Specific_Visa_Document_Requirements]]
- [ ] Plan for Jun-Sep 2027 gap between IMP graduation and Oct 2027 Kenkyusei start (COE timing + embassy processing) -> [[UTokyo_RIKEN]]

## Post-PhD Path

- [ ] Designated Activities for job hunting (Tokutei Katsudo) - re-verify ISA/MOJ rules before action -> [[Designated_Activities_for_Job_Hunting_Tokutei_Katsudo]]
- [ ] Transition to work status (Engineer/Specialist in Humanities/International Services or another applicable status) -> [[Engineer_Specialist_in_Humanities_International_Services]]
- [ ] Highly Skilled Professional (point-based): assess points and PR fast-track eligibility -> [[Highly_Skilled_Professional_HSP_System]]
...
- [[Osaka_University]] - **BACKUP** target in Kansai; activate if UTokyo path encounters critical blockers
- [x] [[RIKEN_IPA_Application_Notes]] - IPA researched and rejected (degree remains at CAS/IMP; not aligned with UTokyo-degree objective)
...
- [[Fundamental_Knowledge]] - Physics/math review for entrance exams
- [[UTokyo_RIKEN]] - Primary strategy and risk register
- [[Osaka_University]] - Backup timeline and admissions signals

...
## Quick Facts
- Position: Associate Professor, Center for Nuclear Study (CNS), Graduate School of Science, The University of Tokyo.[^imai-utokyo]
...
- Detector development includes gamma-ray detectors, recoiled particle detectors, and ultra-thin diamond detectors.[^imai-lab]
- Development of the OEDO decelerator for low-energy RI beams (CNS equipment program).[^imai-lab][^sharaq-oedo]
...
> **Assessment: Medium-High for nuclear reactions + instrumentation; medium for ML.**
> - Strong overlap with detector development and RI-beam experiments; OEDO and related low-energy beamline work are relevant to tracking/PID workflows.[^imai-lab][^sharaq-oedo]
> - No explicit TPC focus is stated publicly; ML/TPC expertise should be framed as transferable reconstruction and analysis tools.

## Suggested Outreach Angle
- Emphasize detector-development experience and ML-based tracking/PID skills as complementary analysis tools for low-energy RI-beam experiments.[^imai-lab]
- Highlight direct-reaction interest aligned with RI-beam nuclear-structure measurements.[^imai-lab]

## Sources
[^imai-utokyo]: https://www.s.u-tokyo.ac.jp/en/people/imai_nobuaki/

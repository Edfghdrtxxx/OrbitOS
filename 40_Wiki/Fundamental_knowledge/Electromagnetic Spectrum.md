---
area: "[[Physics]]"
tags: [fundamental-physics, electromagnetism, radiation]
created: 2026-03-05
last_reviewed:
...
- A ⁵⁷Co source emits 122 keV and 136 keV photons (hard X-ray/gamma boundary), detected by an [[HPGe Detector]] in [[Gamma Spectroscopy]]
- Cherenkov radiation from relativistic particles in water spans the visible-to-UV range and is detected by [[Photomultiplier Tube|PMTs]], while the same particle's ionisation produces signals in a [[Time Projection Chamber]] via charge collection
...
- Griffiths, D. J. (2017). *Introduction to Electrodynamics*, 4th ed. Cambridge University Press — Ch. 9

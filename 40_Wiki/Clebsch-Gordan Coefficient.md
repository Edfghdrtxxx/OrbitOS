...
- **Nuclear $(d,p)$ reaction:** In ${}^{14}\text{C}(d,p){}^{15}\text{C}$, the isospin CG coefficient $C$ accounts for coupling a transferred neutron ($t = 1/2$) to the ${}^{14}\text{C}$ core isospin, and the experimentally extracted $C^2S$ is compared against [[Nuclear Shell Model|shell-model]] predictions.

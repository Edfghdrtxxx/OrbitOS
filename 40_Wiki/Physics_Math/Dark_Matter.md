---
area: "[[Physics]]"
tags: [cosmology, particle-physics, astrophysics]
created: 2026-04-10
last_reviewed:
...
![[Dark_Matter_graph.svg]]
*Galaxy rotation curve of UGC 11455 showing observed velocities exceeding predictions from visible matter alone — a key signature of dark matter. (CC BY-SA, Wikimedia Commons)*

![[Dark_Matter_diagram.jpg]]
...
- The Bullet Cluster (1E 0657-56) provides direct evidence: X-ray-emitting gas (visible matter) is spatially offset from the gravitational mass (traced by lensing), demonstrating that most mass is non-luminous
- Experiments such as XENON1T, LUX-ZEPLIN, and PandaX search for [[WIMP]] recoils using liquid xenon time projection chambers; [[ATLAS]] and CMS at [[CERN]] search for dark matter production via missing transverse momentum
...
- Bertone, G., Hooper, D., & Silk, J., "Particle dark matter: evidence, candidates and constraints," *Physics Reports* **405**, 279–390 (2005)

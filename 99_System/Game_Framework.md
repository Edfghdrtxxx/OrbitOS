---
title: Life Game Framework
type: system
status: active
created: 2026-02-26
tags: [system, identity, planning, game-framework]
---
# Life Game Framework

> Based on Dan Koe's "How to fix your entire life in 1 day" — adapted to your actual situation as of Feb 2026.
> Review quarterly. Update when reality shifts. This is a living document, not a trophy.

---

## Anti-Vision — What's at Stake If You Lose

> The dull, persistent dissatisfaction you've learned to live with.
...
> Read this when motivation drops. Feel the weight of it.
> *Draft — written with AI assistance from selected prompts. Rewrite in your own words after completing Koe Part 2 (see bottom of this document).*
...
## 1-Year Goal — The Mission (by Feb 2027)
...
This is your sole filter for "does this decision move the mission forward?"

---

## 1-Month Project — The Boss Fight (Feb–Mar 2026)

> What you need to build this month to keep the 1-year goal alive.

**Thesis execution:** Move from "preliminary results exist" to "results are documented, gaps identified, next experiments defined."

Concretely:
- Record the first concrete milestone in the thesis progress log (e.g., baseline established, model architecture documented)
- Document model architecture and training setup
- Identify the 2–3 analysis gaps that remain before writing can start
- Set a draft chapter outline with supervisor

This is the boss fight because the thesis is the gate to everything. Not supervisor outreach, not TOEFL, not Japanese — the degree.

---

## Daily Levers — The Quests

> 3 actions the person you're becoming would simply do every day.
> These are not aspirational. They are the minimum viable identity expression.

| # | Quest | What it looks like |
|---|---|---|
| 1 | **Thesis block** (primary) | 2–4 focused hours: model analysis, writing, or figures — not planning |
| 2 | **One Japan-track task** | Fixed weekly rotation — Mon: Japanese / Tue: Physics problem set / Wed: TOEFL listening / Thu: Japanese / Fri: outreach or admin — 30–60 min |
| 3 | **One connector** | Update a progress log, send one email, or capture one insight in the daily note |

> If you only do Quest 1 every day, you're still winning.
> Quest 2 rotation is a default, not a rule — swap days freely, but ensure each track gets time across the week.

---

## Constraints — The Rules of the Game

> What you will not sacrifice. These make the creativity happen.
...
## Priority Stack (Current Season)

> Thesis and outreach are simultaneous tracks, not a sequential queue. The thesis is the non-negotiable daily anchor; outreach runs in parallel in remaining time. Other tracks sustain in the background.
...
## The Cybernetics Check (Weekly)

> From Koe Section V: act → sense → compare → iterate.

Every Sunday (or in your weekly daily note), answer:
1. Did I do the thesis block daily? How many days?
2. Did I do one Japan-track task daily?
3. What specific progress happened in the thesis this week?
4. Am I moving toward the anti-vision or the vision?
5. What's the one change to make next week?

---

## Koe Part 2 — Interrupting Autopilot (Not Yet Done)

> Koe's protocol requires a dedicated full day of timed self-interrupts (phone reminders every 2 hours with specific questions). This section of the protocol was NOT completed during the initial session.

**Schedule this before your first quarterly review.** On a free day:
- Set 6 phone reminders at 11am, 1:30pm, 3:15pm, 5pm, 7:30pm, 9pm
- Each asks one of Koe's autopilot-interruption questions (see source)
- Do not plan this day in advance — observe what you actually do

Source questions: [[How to fix your entire life in 1 day]] — "Part 2: Throughout The Day"

*Updated: 2026-02-26. Source: [[How to fix your entire life in 1 day]].*
